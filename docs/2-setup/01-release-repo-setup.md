...
CommunityMerch-Fundraising-          CommunityMerch-Platform-Release
Platform                                  ↓ フォーク
...
2. 以下の通り入力する：
   ...
   | 項目 | 入力内容 |
   |------|---------|
   | Repository name | `CommunityMerch-Platform-Release` |
...
1. ブラウザで以下の URL を開く：
   `https://github.com/madbarbarian/CommunityMerch-Platform-Release/settings/keys`
...
```yaml
git clone git@github.com:madbarbarian/CommunityMerch-Platform-Release.git /tmp/release
```
...
`https://github.com/madbarbarian/CommunityMerch-Platform-Release` を開いて、
...
`https://github.com/madbarbarian/CommunityMerch-Platform-Release`
...
2. アップデートをリリースしたら、各ライセンシーのリポジトリに対して Pull Request を作成する
   ...
   - 「compare across forks」→ head に `madbarbarian/CommunityMerch-Platform-Release` を指定
